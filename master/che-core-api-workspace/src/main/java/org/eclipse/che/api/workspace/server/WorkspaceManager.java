...
public class WorkspaceManager {
     ...
     *         when any server error occurs
     */
    public WorkspaceImpl getWorkspace(String name, String owner) throws NotFoundException, ServerException {
        requireNonNull(name, "Required non-null workspace name");
        requireNonNull(owner, "Required non-null workspace owner");
    ...
    public List<WorkspaceImpl> getWorkspaces(String namespace) throws ServerException {
        ...
        final List<WorkspaceImpl> workspaces = workspaceDao.getByOwner(namespace);
     ...
     *         when any other error occurs
     */
    public WorkspaceImpl updateWorkspace(WorkspaceImpl workspace) throws ConflictException,
                                                                         ServerException,
                                                                         NotFoundException {
