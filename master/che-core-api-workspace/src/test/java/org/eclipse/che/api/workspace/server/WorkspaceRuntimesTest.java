...
public class WorkspaceRuntimesTest {
    ...
    @Test(expectedExceptions = ServerException.class,
          expectedExceptionsMessageRegExp = "Could not perform operation after post construct invoked")
    ...
    public void shouldNotDestroyNonDevMachineIfRegistryWasStoppedWhileDevMachineWasStarting() throws Exception {
        ...
        try {
            ...
            assertEquals(ex.getMessage(), "Could not perform operation after post construct invoked");
        }
