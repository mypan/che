...
public class GitHubAuthenticatorImpl implements OAuth2Authenticator, OAuthCallback, GitHubAuthenticatorViewImpl.ActionDelegate {
    ...
    public static final String GITHUB      = "org/eclipse/che/ide/ext/github";
    ...
    private String getAuthUrl() {
        return  OAuth2AuthenticatorUrlProvider.get(baseUrl, "org/eclipse/che/ide/ext/github", appContext.getCurrentUser().getProfile().getUserId(), Lists
        ...
        if (githubKeyUploader != null) {
            ...
            githubKeyUploader.uploadKey(userId, new AsyncCallback<Void>() {
                ...
                public void onSuccess(Void result) {
                    callback.onSuccess(authStatus);
                    notificationManager.notify(locale.authMessageKeyUploadSuccess(), Status.SUCCESS, true);
                }
