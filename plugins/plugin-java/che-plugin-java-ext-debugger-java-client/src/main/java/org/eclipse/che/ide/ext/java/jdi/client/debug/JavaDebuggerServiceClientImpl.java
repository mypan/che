 ...
 */
@Singleton
public class JavaDebuggerServiceClientImpl implements DebuggerServiceClient<JavaDebuggerConnectionContext> {
    ...
    @Override
    public Promise<JavaDebuggerInfo> connect(@NotNull JavaDebuggerConnectionContext connectionContext) {
        final String requestUrl = baseUrl + "/connect";
        final String params = "?host=" + connectionContext.getHost() + "&port=" + connectionContext.getPort();
    ...
    @Override
    public Promise<BreakPointList> getAllBreakpoints(@NotNull String id, @NotNull AsyncRequestCallback<String> callback) {
