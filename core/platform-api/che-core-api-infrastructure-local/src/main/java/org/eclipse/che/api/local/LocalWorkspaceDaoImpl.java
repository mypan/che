...
public class LocalWorkspaceDaoImpl implements WorkspaceDao {
    ...
    @Override
    public synchronized List<WorkspaceImpl> getByOwner(String owner) throws ServerException {
    ...
    private WorkspaceImpl doClone(WorkspaceImpl workspace) {
        WorkspaceImpl copyWorkspace = new WorkspaceImpl(new WorkspaceConfigImpl(workspace.getConfig()),
                                                        workspace.getId(),
                                                        workspace.getNamespace());
